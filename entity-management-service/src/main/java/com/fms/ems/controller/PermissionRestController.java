...
public class PermissionRestController {
  ...
  public ResponseEntity<Permission> updatePermission(
      @PathVariable String id, @RequestBody Permission permission) {
    try {
      Optional<Permission> permissionToBeUpdated =
          permissionRepository.findById(Integer.parseInt(id));
  ...
  public ResponseEntity<Permission> deletePermission(@PathVariable String id) {
    try {
      Optional<Permission> permissionToBeDeleted =
          permissionRepository.findById(Integer.parseInt(id));
